class Pagination:
    ...
    def __init__(self, page, all_count, params, per_num=15, max_show=5):
        try:
            page = int(page)
            if page <= 0:
                page = 1
    ...
    def page_html(self):
        ...
        for i in range(self.page_start, self.page_end + 1):
            ...
            if self.page == i:
                li_list.append('<li class="paginate_button active"><a href="?{0}">{1}</a></li>'.format(self.params.urlencode(), i))
            else:
